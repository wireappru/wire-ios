...
- Carthage 0.28.0 or newer (https://github.com/Carthage/Carthage)
- CocoaPods 1.3.1 or newer (https://cocoapods.org/)
- Ruby 2.3.3 (we suggest using `rbenv` to install the correct version https://github.com/rbenv/rbenv/)
- Python 2.7
